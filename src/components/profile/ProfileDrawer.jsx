    ...
    return(
      ...
      >
       ...
       <MotionDrawerContent
                ...
                ml={5} maxW={"510px"} h={"709.5px"} mt={5}
            >
          ...
          <DrawerBody overflow={'hidden'}>  {/*drawer body needs the overflow hidden */}
            ...
            <Box backgroundColor={"mistyrose"}  ml={-8}  mt={0} width={"530px"} height={"240px"} display="flex" flexDirection="column" justifyContent="flex-end" >
